        ...
        <Card className="bg-white border-slate-200 shadow-md">
            <CardHeader className="border-b border-slate-100 pb-4">
                <div className="flex items-center gap-3">
                    ...
                    <div>
                        <CardTitle className="text-lg text-slate-900">AI Model Configuration</CardTitle>
                        <CardDescription className="text-slate-500">Fine-tune the Gemini integration.</CardDescription>
                    </div>
                </div>
            </CardHeader>
            <CardContent className="pt-6 space-y-4">
                <div>
                    <label className="text-sm font-medium text-slate-700 mb-1.5 block">Model Version</label>
                    <Input 
                        value={localConfig.aiModelVersion}
                        onChange={(e) => setLocalConfig({...localConfig, aiModelVersion: e.target.value})}
                        className="bg-slate-50 border-slate-200 text-slate-900 focus:border-brand-purple"
                    />
                    <p className="text-xs text-slate-400 mt-1">Currently active model for user-facing generation tasks.</p>
                </div>
            </CardContent>
        </Card>
        ...
        <Card className="bg-white border-slate-200 shadow-md">
            <CardHeader className="border-b border-slate-100 pb-4">
                <div className="flex items-center gap-3">
                    ...
                    <div>
                        <CardTitle className="text-lg text-slate-900">Access & Security</CardTitle>
                        <CardDescription className="text-slate-500">Manage platform availability and limits.</CardDescription>
                    </div>
                </div>
            </CardHeader>
            <CardContent className="pt-6 space-y-6">
                ...
                <div className="grid grid-cols-2 gap-6">
                    <div>
                        <label className="text-sm font-medium text-slate-700 mb-1.5 block">Max Daily Sessions</label>
                        <Input 
                            type="number" 
                    ...
                    <div>
                        <label className="text-sm font-medium text-slate-700 mb-1.5 block">Default Time Limit (Mins)</label>
                        <Input 
                            type="number"
