          ...
          >
            <CardHeader className="pb-3">
              <div className="flex justify-between items-start mb-2">
                ...
                >
                  {dataset.isActive ? <ToggleRight className="h-9 w-9 text-green-500" /> : <ToggleLeft className="h-9 w-9 text-slate-300" />}
                </button>
              </div>
            ...
            <CardContent>
               <div className="bg-slate-50 rounded-lg p-3 space-y-2 border border-slate-100">
                  ...
                  <div className="flex justify-between items-center text-sm">
                    ...
                    <span className="font-mono text-slate-600">{new Date(dataset.lastUpdated).toLocaleDateString()}</span>
                  </div>
               </div>
            </CardContent>
